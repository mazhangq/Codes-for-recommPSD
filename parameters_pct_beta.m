...
load('data/param_pct_beta_us.mat');
load('data/param_pct_beta_it.mat');
hh=numel(betas);
figure;
...
%axis([1 5 0.7 0.78]);
legend({'5%+UB','5%+IB','4%+UB','4%+IB','3%+UB','3%+IB',...
    '2%+UB','2%+IB','1%+UB','1%+IB'},...
    'Location','northwest','NumColumns',5);
xlabel('Parameter \beta');
ylabel('MAEs');
ax=gca;
ax.XTickLabel = {'0.00001','0.00005','0.0001',...
    '0.0005','0.001','0.005','0.01','0.005','0.1'};
